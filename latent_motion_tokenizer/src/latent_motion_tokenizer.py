...
class LatentMotionTokenizer(nn.Module):
    ...
    def forward(self, cond_pixel_values, target_pixel_values,
                extra_cond_pixel_values=None, extra_target_pixel_values=None,
        ...
        # 
        if extra_cond_pixel_values is not None:
            assert extra_target_pixel_values is not None
            extra_cond_hidden_states = self.image_encoder(extra_cond_pixel_values).last_hidden_state
            extra_target_hidden_states = self.image_encoder(extra_target_pixel_values).last_hidden_state
            
            cond_pixel_values = extra_cond_pixel_values.clone().detach()
            target_pixel_values = extra_target_pixel_values.clone().detach()
            cond_hidden_states = extra_cond_hidden_states.clone().detach()
            target_hidden_states = extra_target_hidden_states.clone().detach()
